...
final class Version20240217123456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("
            INSERT INTO employee (id, name, surname, date_of_employment, department_id, base_salary_amount, base_salary_currency)
            VALUES ('01HPWKGW52J5KCY9DYQJQQJ591', 'Monika', 'Testowa', '2020-02-17 13:42:36', '01HPVH92RWMSQKENF5WJPQ8G24', 50000, 'usd');
        ");
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql("delete from employee where id in('01HPVHCSEK0FSGBEJ7HW43VRN7', '01HPVHCX0211AN7V97RQR3179D', '01HPWKGW52J5KCY9DYQJQQJ591');");
    }
}
